...
public class UserController {
    ...
    public String saveUser(User user, RedirectAttributes rd) {
        service.save(user);
        rd.addFlashAttribute("message", "The user saved susscessfully!!!");
        return "redirect:/users";
    }

    @GetMapping("users/edit/{id}")
    public String showEditForm(@PathVariable("id") Integer id, Model model, RedirectAttributes rd) {
        try {
            ...
            rd.addFlashAttribute("message", "Fail to edit!!!");
            return  "redirect:/users";
        }
